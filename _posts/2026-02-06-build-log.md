...
i spent the day solidifying [gatewaystack](https://github.com/davidcrowe/GatewayStack). that meant extracting proxy logic, fixing regex bugs, and prepping all 12 packages for npm publishing. i also gave the marketing site a much-needed facelift and improved the connect dashboard.
