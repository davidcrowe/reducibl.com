...
layout: post
category: buildlog
title: "build log: feb 18 — clawhub security audit"
...
### gatewaystack: a new onramp
i'm starting to think of gatewaystack-connect as a new onramp for gatewaystack. by offering a free tier, i can give developers a chance to try out the platform and see the value for themselves. it's a way to build credibility and win deals with enterprise customers.
